...
oSection2 := TRSection():New( oSection1 , "ITENS DAS NF DE ENTRADA",{"SD1","SB1"} ) 
...
SELECT A2_COD, A2_LOJA, A2_NOME, B1_COD, B1_DESC, D1_QUANT,D1_VUNIT,D1_TOTAL FROM %table:SD1%  AS SD1
